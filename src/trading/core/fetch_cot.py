        ...
        with open(csv_file, newline="", encoding="utf-8") as f:
            ...
            for row in reader:
                ...
                if report_id == "tff":
                    ...
                    cs = safe_int(row.get("Change_in_Lev_Money_Long_All", 0)) - safe_int(
                        row.get("Change_in_Lev_Money_Short_All", 0)
                    )
                    entry = {
                        "date": date,
                        "market": mkt,
                    ...
                    nl = safe_int(row.get("NonRept_Positions_Long_All", 0))
                    ns = safe_int(row.get("NonRept_Positions_Short_All", 0))
                    cs = safe_int(row.get("Change_in_NonComm_Long_All", 0)) - safe_int(
                        row.get("Change_in_NonComm_Short_All", 0)
                    )
                    entry = {
                        "date": date,
                        "market": mkt,
                    ...
                    nl = safe_int(row.get("NonRept_Positions_Long_All", 0))
                    ns = safe_int(row.get("NonRept_Positions_Short_All", 0))
                    cs = safe_int(row.get("Change_in_M_Money_Long_All", 0)) - safe_int(
                        row.get("Change_in_M_Money_Short_All", 0)
                    )
                    entry = {
                        "date": date,
                        "market": mkt,

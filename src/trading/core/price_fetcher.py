...
from src.trading.scrapers import yahoo_finance, stooq, twelvedata, finnhub, fred
...
COT_MAP = {
    ...
    "Brent": "crude oil, light sweet", "WTI": "crude oil, light sweet",
    "SPX": "s&p 500 consolidated", "NAS100": "nasdaq mini", "DXY": "usd index",
}
...
def fetch_prices(
    symbol: str, interval: str, range_or_size: str,
